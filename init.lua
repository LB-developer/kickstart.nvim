        ...
        callback = function()
          vim.lsp.buf.code_action {
            context = {
              ...
              diagnostics = {}, -- Add an empty diagnostics table
            },
            apply = true,
          }
        end,
        ...
        gopls = {
          settings = {
            gopls = {
              ...
              ['local'] = 'your_module_path', -- Optional, for import sorting
            ...
            -- The key part:
            format = {
              -- Set to `goimports` to automatically format and organize imports
              -- instead of `gofmt`
              command = { 'goimports' },
            },
          },
